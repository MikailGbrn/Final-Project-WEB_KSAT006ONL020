...
WebUI.setText(findTestObject('Object Repository/Product/Page_Beanie  Kotakoki/textarea__comment'), komen)
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Product/Page_Comment Submission Failure/p_Error Please fill the required fields'))
